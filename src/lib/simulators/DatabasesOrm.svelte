	...
	<div class="space-y-4 font-mono text-sm sm:text-base">
		...
		<div class="space-y-2.5">
			...
			{#if poolExhausted}
				...
				>
					⚠️ TCP Connection limit reached! Traditional Postgres pools reject incoming edge lambdas.
					Use Neon HTTP query pipelines or Turso LibSQL to bypass TCP handshake limits.
				</div>
			{:else}
				<div
