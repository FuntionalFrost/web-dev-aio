export const SITE = {
	...
	description:
		'Production-grade reference architecture and 35 interactive engineering labs covering Svelte 5 (Runes & Async), SvelteKit 2, Nuxt 4, Tailwind v4, TS6, Nitro, Hono, Bun, Deno, and Edge Cloud.',
